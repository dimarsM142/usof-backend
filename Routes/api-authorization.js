...
const {postRegister, postLogin, getRefresh, postLogout, postSendPassword, postResetPassword} = require('../Controllers/api-authorization-controller.js');


router.post('/api/auth/register', postRegister);
router.post('/api/auth/login/', postLogin);
router.get('/api/auth/refresh', getRefresh);
